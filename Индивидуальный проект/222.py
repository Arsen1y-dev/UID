    ...
    def open_main_window(self):
        if self.user_role == "employee":
            self.main_window = MainWindow(self.user_role,
                                          self.entry_login.text())  # Открываем MainWindow для сотрудника
        elif self.user_role == 'admin':
            self.main_window = AdminMainWindow(self.entry_login.text())  # Открываем AdminMainWindow для админа
        else:  # Клиент
            self.main_window = ClientMainWindow(self.entry_login.text())  # Создаем ClientMainWindow
